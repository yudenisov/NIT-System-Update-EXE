...
#Region "Методы работы с реестром"
        ' *********************************************************************************
        '
        ' Subroutine Win10_WriteRegistry
        ...
        '
        ' ****************************************************************************
        Public Sub Win10_WriteRegistry(ByVal strSection As String)
            ...
            If IO.File.Exists(szFullRegProgram) Then
                ...
                strEcho = strEcho & "Ваша Windows 8.1,10/Windows Server 2012 R2/2016" & vbCrLf
                strEcho = strEcho & "нуждается в обновлении. Будут установлены" & vbCrLf
                strEcho = strEcho & "обновления: " & vbCrLf
                ...
                strEcho = strEcho & "раз перезагрузится (до трёх раз). Примерное" & vbCrLf
                ...
                If strSection Is Nothing Or strSection.Length = 0 Then
                    ...
                    ' Test
                    Console.WriteLine("Key = 1" & vbCrLf & "Value = " & Chr(34) & szFullRegProgram & Chr(34) & " " & Chr(34) & UPDATE_SEC_SECTION & Chr(34))
                    Registry.SetValue(REGISTRY_KEY_EX, "1", Chr(34) & szFullRegProgram & Chr(34) & " " & Chr(34) & UPDATE_SEC_SECTION & Chr(34))
                Else
