...
Module Module1
    ...
    Sub Install_IE11Updates()
        ...
        iResult = 0
        Const Section_Name1 As String = "Windows6.1-KB2888049-x86"
        Const Section_Name2 As String = "Windows6.1-KB2882822-x86"
        Const Section_Name3 As String = "Windows6.1-KB2834140-v2-x86"
        Const Section_Name4 As String = "Windows6.1-KB2786081-x86"
        Const Section_Name5 As String = "Windows6.1-KB2731771-x86"
        Const Section_Name6 As String = "Windows6.1-KB2729094-v2-x86"
        Const Section_Name7 As String = "Windows6.1-KB2670838-x86"
        Const Section_Name8 As String = "Windows6.1-KB2533623-x86"
        Const Section_Name9 As String = "Windows6.1-KB2639308-x86"
