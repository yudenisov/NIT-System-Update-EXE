...
#Region "Методы работы с реестром"
		' *********************************************************************************
		'
		' Subroutine Win7x64_WriteRegistry
        ...
        '
        ' ****************************************************************************
		Public Sub Win7x64_WriteRegistry(ByVal strSection As String)
			Dim szINI as String
            Dim iNum As Integer
            Dim szFullRunScript, szFullRegProgram As String
            szFullRunScript = Me.strProjectRoot_IUW & "\" & WRITE_REGISTRYSCRIPT
            szFullRegProgram = Me.strProjectRoot_IUW & "\" & WRITE_REGISTRYPROGRAM
            Dim strEcho As String
            If IO.File.Exists(szFullRunScript) Then
                If IO.File.Exists(szFullRegProgram) Then
                    ...
                    Else
                        ...
                        If IO.File.Exists(szINI) Then
                            ...
                            Else
                                ' Test
                                Console.WriteLine("Key1 Value = " & Chr(34) & Me.strProjectRoot_IUW & "\" & szRegProgram & Chr(34))
                                Registry.SetValue(REGISTRY_KEY_EX, "1", Chr(34) & Me.strProjectRoot_IUW & "\" & szRegProgram & Chr(34))
